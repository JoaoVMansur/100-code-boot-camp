...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        true_image = PhotoImage(file="D:/projetos/Boot camp 100 days/day 34/images/true.png")
        self.true_button = Button(image=true_image, highlightthickness= 0, command= self.true)
        self.true_button.grid(row=2, column=0)
        
        false_image = PhotoImage(file="D:/projetos/Boot camp 100 days/day 34/images/false.png")
